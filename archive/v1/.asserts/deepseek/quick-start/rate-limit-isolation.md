...
## Concurrency Limit[​](#concurrency-limit "Direct link to Concurrency Limit")
...
## user\_id Isolation[​](#user_id-isolation "Direct link to user_id Isolation")
...
### Setting user\_id[​](#setting-user_id "Direct link to Setting user_id")
...
#### OpenAI Chat Completions API[​](#openai-chat-completions-api "Direct link to OpenAI Chat Completions API")
...
## Request Keep-Alive Mechanism[​](#request-keep-alive-mechanism "Direct link to Request Keep-Alive Mechanism")
