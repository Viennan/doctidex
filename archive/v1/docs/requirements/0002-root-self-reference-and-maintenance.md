...
相关当前设计入口包括 [User Surface](../doctidex-git/architecture/product-and-user-surfaces.md)、
[工作流](../doctidex-git/architecture/index.md)、[领域模型](../doctidex-git/architecture/index.md)、
