...
# doctidex-git 0.1.0 Architecture 导航

归档状态：历史设计，仅用于解释 `0.1.0` surface 和尚未替换的旧代码；不定义 v1 目标。

本 Architecture 描述 `doctidex-git` `0.1.0` 是什么样子。它以 user surface 为起点，随后解释
