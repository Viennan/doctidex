...
<Tabs>
<Tab zoneid="bFvfZAxFFS" title="快速入口">
<TabTitle>快速入口</TabTitle>

<span>![图片](https://portal.volccdn.com/obj/volcfe/cloud-universal-doc/upload_a5fdd3028d35cc512a10bd71b982b6eb.png) </span> [计费说明](https://www.volcengine.com/docs/82379/1099320#%E4%B8%8A%E4%B8%8B%E6%96%87%E7%BC%93%E5%AD%98%E8%AE%A1%E8%B4%B9) <span>![图片](https://portal.volccdn.com/obj/volcfe/cloud-universal-doc/upload_afbcf38bdec05c05089d5de5c3fd8fc8.png) </span> [API Key](https://console.volcengine.com/ark/region:ark+cn-beijing/apiKey?apikey=%7B%7D) <span>![图片](https://portal.volccdn.com/obj/volcfe/cloud-universal-doc/upload_2abecd05ca2779567c6d32f0ddc7874d.png) </span> [支持模型](https://www.volcengine.com/docs/82379/1330310#e6772192)
...
<Tab zoneid="VVf78TpHB9" title="鉴权说明">
...
<div data-tips="true" data-tips-type="tip">messages. <strong>content</strong> 与 messages. <strong>tool_calls</strong> 字段二者至少填写其一。</div>
...
<div data-tips="true" data-tips-type="tip">模型并不总是生成有效的 JSON，并且可能会虚构出一些您的函数参数规范中未定义的参数。在调用函数之前，请在您的代码中验证这些参数是否有效。</div>
...
* `true`：在历史消息长度接近上下文长度时模型按照先进先出的顺序，自动删除定量（ **rolling_window_tokens** 字段值 token 数）的内容，为新对话内容腾挪缓存空间；同时对缓存中的信息进行重新计算和读入，保障内容理解一致性。具体的计算逻辑，请参见 [rolling_tokens 模式](https://www.volcengine.com/docs/82379/1396491#a0e4efde)。
