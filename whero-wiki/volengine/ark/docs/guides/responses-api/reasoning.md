...
250615及之后版本的大语言模型，如无特殊说明，默认支持 Responses API，具体请参见[深度思考能力](https://www.volcengine.com/docs/82379/1330310#43b6e6a1)。
...
<div data-tips="true" data-tips-type="tip">若应用是非流式输出场景，建议先以流式输出方式获取完整内容后再输出，这样既能避免任务超时失败，又能满足应用的输出需求。</div>



<Tabs>
<Tab zoneid="XjPrLhzFTk" title="Curl">
...
<Tab zoneid="LKb7RL2Svc" title="Python">
...
<Tab zoneid="drpOQnHXf4" title="Go">
...
<Tab zoneid="wYrREpBcvm" title="Java">
...
<Tab zoneid="vndv0Xo9SO" title="OpenAI SDK">
...
<Tabs>
<Tab zoneid="PWfSQ4xrsX" title="Curl">
<TabTitle>Curl</TabTitle>
...
<Tab zoneid="ZA9AMwnQLT" title="Python">
<TabTitle>Python</TabTitle>
...
<Tab zoneid="CFv1lqiMgA" title="Go">
<TabTitle>Go</TabTitle>
...
<Tab zoneid="kAls8sFqfJ" title="Java">
<TabTitle>Java</TabTitle>
...
<Tab zoneid="YVJUEWhewm" title="OpenAI SDK">
<TabTitle>OpenAI SDK</TabTitle>
...
在工具调用场景，需要回传思考内容，支持的回传方式如下。回传思考内容示例参见[回传思考内容加密原文](https://www.volcengine.com/docs/82379/1449737#8cfd447b)。


* **previous_response_id** （推荐）： 自动获取原始思考内容并回传给模型参与推理。
...
通过 **reasoning.effort** 调节思维链长度，平衡不同场景对效果、时延、成本的需求。取值如下：
...
<div data-tips="true" data-tips-type="warning"><strong>reasoning.effort</strong> 的默认取值为 <code>medium</code>。</div>
...
<Tabs>
<Tab zoneid="TRWy12u8bW" title="Curl">
<TabTitle>Curl</TabTitle>
...
<Tab zoneid="WcnQhr9zoK" title="Python">
<TabTitle>Python</TabTitle>
...
<Tab zoneid="HvLLHjIU7K" title="Go">
<TabTitle>Go</TabTitle>
...
<Tab zoneid="wZ2XGn7ZSN" title="Java">
<TabTitle>Java</TabTitle>
...
<Tab zoneid="RL9oLjkE92" title="OpenAI SDK">
<TabTitle>OpenAI SDK</TabTitle>
...
<Tabs>
<Tab zoneid="xZOiYxpPs5" title="Curl">
<TabTitle>Curl</TabTitle>
...
<Tab zoneid="LvtyKimK6z" title="Python">
<TabTitle>Python</TabTitle>
...
<Tab zoneid="KEcUwg7KoP" title="Go">
<TabTitle>Go</TabTitle>
...
<Tab zoneid="xTj2pRn0vT" title="Java">
<TabTitle>Java</TabTitle>
...
<Tab zoneid="Ms3zSeoxZa" title="OpenAI SDK">
<TabTitle>OpenAI SDK</TabTitle>
...
|流程图 |说明 |
|---|---|
|<span>![图片](https://arkdoc.tos-cn-beijing.volces.com/flowcharts/responses-api/deep-thinking-01.svg) </span> |* 在每一轮对话过程中，深度思考模型会输出思维链内容（COT）和最终回答（Answer）。<br><br>* 在下一轮对话中，之前输出的思维链内容不会被拼接到上下文中。<br><br>> 思维链内容展现的是模型处理问题的过程，包括将问题拆分为多个问题进行处理，生成多种回复综合得出更好回答等过程。 |
...
|流程图 |说明 |
|---|---|
|<span>![图片](https://arkdoc.tos-cn-beijing.volces.com/flowcharts/responses-api/deep-thinking-02.svg) </span> |* 回答问题 1 时（请求 1.1 \- 1.2），模型进行多次思考 + 工具调用后给出答案，方舟会输入完整上下文包括思维链内容给模型处理。<br><br>* 开始回答问题2时（请求 2.1），方舟会自行判断并删除之前上下文中的思维链，输入给模型。 |
