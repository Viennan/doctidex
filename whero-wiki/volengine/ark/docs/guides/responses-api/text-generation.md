...
<Tabs>
<Tab zoneid="udqNwLPjlx" title="Curl">
...
<Tab zoneid="peYKLMI8YS" title="Python">
...
<Tab zoneid="szM8rPjY8z" title="Go">
...
<Tab zoneid="pokqbM0JIU" title="Java">
...
<Tab zoneid="f1wE1S9UUz" title="OpenAI SDK">
...
上下文状态管理简单，默认情况下每个请求的输入和回复（不包括思维链内容） 都会持久化存储，后续请求只需传入 id 就可以引入对应请求的输入和回复，无需像 Chat API 每次请求，传入历史对话。详细信息，参见[工作原理及使用说明](https://www.volcengine.com/docs/82379/1958520#bdafc901)。
...
<Tabs>
<Tab zoneid="ljyJOHozjK" title="Curl">
<TabTitle>Curl</TabTitle>
...
<Tab zoneid="tPJMvmALF9" title="Python">
<TabTitle>Python</TabTitle>
...
<Tab zoneid="R0ZhyqLA6l" title="Go">
<TabTitle>Go</TabTitle>
...
<Tab zoneid="MA4v0sL6Q9" title="Java">
<TabTitle>Java</TabTitle>
...
<Tab zoneid="K1KWbUv0na" title="OpenAI SDK">
<TabTitle>OpenAI SDK</TabTitle>
...
<Tabs>
<Tab zoneid="rRWU2UGBsR" title="Python">
<TabTitle>Python</TabTitle>
...
<Tab zoneid="gD5Fcje6If" title="Go">
<TabTitle>Go</TabTitle>
...
<Tab zoneid="GYcT8Xn0SX" title="Java">
<TabTitle>Java</TabTitle>
...
<Tab zoneid="JL0C8w9rp7" title="OpenAI SDK">
<TabTitle>OpenAI SDK</TabTitle>
...
<Tabs>
<Tab zoneid="nT80GFF2Ut" title="Python">
<TabTitle>Python</TabTitle>
...
<Tab zoneid="VChemXiHIE" title="Go">
<TabTitle>Go</TabTitle>
...
<Tab zoneid="rr31sjEXt8" title="Java">
<TabTitle>Java</TabTitle>
...
<Tab zoneid="BqDeDsFAnq" title="OpenAI SDK">
<TabTitle>OpenAI SDK</TabTitle>
...
<Tabs>
<Tab zoneid="BgBWwltGr0" title="Curl">
<TabTitle>Curl</TabTitle>
...
<Tab zoneid="FBUHRlocJ4" title="Python">
<TabTitle>Python</TabTitle>
...
<Tab zoneid="bgffGY2nAj" title="Go">
<TabTitle>Go</TabTitle>
...
<Tab zoneid="RWYfQy4wsL" title="Java">
<TabTitle>Java</TabTitle>
...
<Tab zoneid="YNol4SGmi0" title="OpenAI SDK">
<TabTitle>OpenAI SDK</TabTitle>
...
<Tabs>
<Tab zoneid="uvzGuU4Wed" title="Python">
<TabTitle>Python</TabTitle>
...
<Tab zoneid="voBqRA82xz" title="Go">
<TabTitle>Go</TabTitle>
...
<Tab zoneid="g124mEhOfJ" title="Java">
<TabTitle>Java</TabTitle>
...
<Tab zoneid="wSgmOL0MJT" title="OpenAI SDK">
<TabTitle>OpenAI SDK</TabTitle>
...
<div data-tips="true" data-tips-type="warning">使用续写模式，需注意：</div>



* <div data-tips="true" data-tips-type="warning">新一轮输入支持将<code>assistant</code>角色的 <strong>content</strong> 设置为空进行 Prefill，实现模型多轮连续回答。</div>


* <div data-tips="true" data-tips-type="warning">支持使用前缀缓存和 <strong>Session</strong> 缓存。其中 <strong>Session</strong> 缓存场景下，缓存存储、下一轮的命中缓存，都按本轮输入 <strong>tokens</strong> 计算。</div>


* <div data-tips="true" data-tips-type="warning">不支持结构化输出（ <strong>json_object</strong> 模式和 <strong>json_schema</strong> 模式）。</div>


* <div data-tips="true" data-tips-type="warning">建议不要与内置工具搭配使用。因涉及大模型调用和工具调用的循环逻辑，续写模式下的 <strong>content</strong> 无法作为最终输出的起点内容，导致续写模式失效。</div>
...
<Tabs>
<Tab zoneid="hETK66HIz0" title="Curl">
<TabTitle>Curl</TabTitle>
...
<Tab zoneid="MuwJTIOwjI" title="Python">
<TabTitle>Python</TabTitle>
...
<Tab zoneid="WUHoE7x3Co" title="Go">
<TabTitle>Go</TabTitle>
...
<Tab zoneid="KsLl2wjr6G" title="Java">
<TabTitle>Java</TabTitle>
...
<Tab zoneid="QnmIj4xcBU" title="OpenAI SDK">
<TabTitle>OpenAI SDK</TabTitle>
...
<span id="c0a46722"></span>
#### 上下文缓存场景

以 Curl 方式为例介绍在续写模式下使用上下文缓存，其他 SDK 示例参见[上下文缓存](https://www.volcengine.com/docs/82379/1602228)。
...
<span>![图片](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/eb56a7e5a22646278e195c8ced97ec06~tplv-goo7wpa0wc-image.image) </span>
...
* 输入限制：最多支持 1000 个 item（任意角色的一条信息为 1 个 item，如一问一答为2个item）。达到此限制，无法继续对话，可通过删除模型请求接口(/docs/82379/1584286) 手动清理记录。
