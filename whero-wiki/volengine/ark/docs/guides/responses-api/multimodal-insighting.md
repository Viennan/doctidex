...
<span id="b6f7b368"></span>
## 完整教程

Responses API 支持多种文件输入方式：Files API 上传文件、Base64 编码输入和文件 URL 传入。

本文重点介绍 **Files API 上传文件**方式。如需了解其他文件输入方式，以及图片/视频/文档格式要求、文件大小限制、视频抽帧策略等详情，请查看以下教程：
...
模型支持理解图片的信息，并结合这些信息完成如描述其中的物体等视觉相关任务。关于图片理解支持的图片输入方式及示例，请参见[图片理解](https://www.volcengine.com/docs/82379/1362931)。
...
|图片文件 |提示词 |
|---|---|
|<span>![图片](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/8ebf433e57124e1585d2377ba83e4c27~tplv-goo7wpa0wc-image.image) </span> |请给出图片中的内容，并根据图片内容回答支持输入图片的模型系列是哪个？ |
...
<Tabs>
<Tab zoneid="iImNxfqMtW" title="Curl">
...
<Tab zoneid="cmJ2aZNE9s" title="Python SDK">
...
<Tab zoneid="D64m17vOQX" title="Go SDK">
...
<Tab zoneid="LGPnCDgbrg" title="Java SDK">
...
<Tab zoneid="WRC5P6iV0Y" title="兼容 OpenAI SDK">
...
|视频文件 |提示词 |
|---|---|
|<video src="https://p9-arcosite.byteimg.com/obj/tos-cn-i-goo7wpa0wc/608b664aad1b49ce9fd41b597551236b" controls></video><br> |请你描述下视频中的人物的一系列动作，以JSON格式输出开始时间（start_time）、结束时间（end_time）、事件（event）、是否危险（danger），请使用HH:mm:ss表示时间戳。 |
...
<Tabs>
<Tab zoneid="It0TxRnlxj" title="Curl">
<TabTitle>Curl</TabTitle>
...
<Tab zoneid="kPWO0yaxyw" title="Python SDK">
<TabTitle>Python SDK</TabTitle>
...
<Tab zoneid="nPfYel1KVL" title="Go SDK">
<TabTitle>Go SDK</TabTitle>
...
<Tab zoneid="V2Hgic1gHO" title="Java SDK">
<TabTitle>Java SDK</TabTitle>
...
<Tab zoneid="NLBvHkq9vN" title="兼容 OpenAI SDK">
<TabTitle>兼容 OpenAI SDK</TabTitle>
...
|PDF文件 |提示词 |
|---|---|
|<span>![图片](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/0335ac1d4cdc4378bd291584131c2cce~tplv-goo7wpa0wc-image.image) </span> |按段落给出文档中的文字内容，以JSON格式输出，包括段落类型（type）、文字内容（content）信息。 |
...
<Tabs>
<Tab zoneid="Q9Yt45hWTX" title="Curl">
<TabTitle>Curl</TabTitle>
...
<Tab zoneid="NgiaM67RqV" title="Python SDK">
<TabTitle>Python SDK</TabTitle>
...
<Tab zoneid="eLW6Zpwrrw" title="Go SDK">
<TabTitle>Go SDK</TabTitle>
...
<Tab zoneid="icvo8xAdHy" title="Java SDK">
<TabTitle>Java SDK</TabTitle>
...
<Tab zoneid="YJcG9MBKJC" title="兼容 OpenAI SDK">
<TabTitle>兼容 OpenAI SDK</TabTitle>
