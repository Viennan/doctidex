...
* 选择接口：与 OpenAI API 协议兼容（[兼容 OpenAI SDK](https://www.volcengine.com/docs/82379/1330626)），支持 [Responses API](https://www.volcengine.com/docs/82379/1569618)（推荐） 与 [Chat API](https://www.volcengine.com/docs/82379/1494384) 两种接口调用，更多信息参见[迁移至 Responses API](https://www.volcengine.com/docs/82379/1585128)。

* 评测先行：建议建立评测与回归机制，确保提示词迭代的可控性。

* 权限配置：首次接入请参见[快速入门](https://www.volcengine.com/docs/82379/1399008)完成 API Key 获取和环境配置。


<div data-tips="true" data-tips-type="tip" data-tips-is-title="true">说明</div>


<div data-tips="true" data-tips-type="tip">其他模型提示词指南</div>



* <div data-tips="true" data-tips-type="tip">图片生成：<a href="https://www.volcengine.com/docs/82379/1829186">Seedream 4.0\-5.0 提示词指南</a>、<a href="https://www.volcengine.com/docs/82379/1795150">Seedream 3.0 提示词指南</a></div>


* <div data-tips="true" data-tips-type="tip">视频生成：<a href="https://www.volcengine.com/docs/82379/1631633">Seedance\-1.0\-pro&pro\-fast 提示词指南</a>、<a href="https://www.volcengine.com/docs/82379/1587797">【已下线】Seedance\-1.0\-lite 提示词指南</a></div>
...
|模型 |任务与场景 |提示词风格 |
|---|---|---|
|带深度思考的文本生成模型 |复杂任务与多步规划<br><br>需分析、拆解与决策场景 |给目标与约束即可，让模型自拟计划与校验 |
|无/关闭深度思考的文本生成模型 |适合强模板化场景<br><br>明确指令与结构化产出 |更明确的指令，给精确步骤、格式与样例 |
...
<div data-tips="true" data-tips-type="tip"><strong>提示词工程工具 Prompt Pilot</strong></div>


<div data-tips="true" data-tips-type="tip">方舟提供了<a href="https://console.volcengine.com/ark/region:ark+cn-beijing/autope">Prompt Pilot</a>，构建端到端的提示词优化，输入初始 Prompt 智能完成完整提示词工程流程：</div>



* <div data-tips="true" data-tips-type="tip">初始 Prompt 自动生成 评估数据集。</div>


* <div data-tips="true" data-tips-type="tip">生成模型回答并自动打分。</div>


* <div data-tips="true" data-tips-type="tip">智能优化 Prompt，并生成智能优化报告。</div>
...
<div data-tips="true" data-tips-type="tip">建议：把稳定复用的信息放在 <code>system</code> 或 <code>instructions</code> 中，并在每次调用里靠前传入，提升一致性与可维护性。</div>
...
更多说明请参见[角色扮演场景提示词指南](https://www.volcengine.com/docs/82379/1256348)
...
* 使用 [Responses API](https://www.volcengine.com/docs/82379/1569618) 简化上下文管理，在多轮对话场景可通过 `previous_response_id` 传入历史信息，无需手动管理，详见[上下文管理](https://www.volcengine.com/docs/82379/2123288)。

* 使用上下文缓存降低成本：对于固定系统信息及多轮对话，通过缓存输入的低价，降低请求的成本。详见[原理及选型](https://www.volcengine.com/docs/82379/1398933)
