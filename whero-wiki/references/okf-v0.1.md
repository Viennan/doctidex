...
> Historical background only. This document is not a current Whero Wiki
> protocol or conformance source. Use the documents under `../spec/` for the
> active Whero Wiki v0.0.2 protocol.
