...
| ##### 请求体（Request Body） |
| **model** `*string*` **（必选）** 模型名称。可选值为： - `vidu/viduq3-pro-fast_img2video` - `vidu/viduq3-pro_img2video` - `vidu/viduq3-turbo_img2video` - `vidu/viduq2-pro-fast_img2video` - `vidu/viduq2-pro_img2video` - `vidu/viduq2-turbo_img2video` |
