...
| --- | --- | --- | --- | --- | --- |
| `Qwen3.7`、`Qwen3.6`、`Qwen3.5`、`Qwen3-VL`系列模型 | `32*32` | `true` | `max_pixels` 无效 | `16384 Token` | `16777216`（即`16384*32*32`） |
...
| `QVQ`系列模型 | `28*28` | `true` | `max_pixels` 无效 | `16384 Token` | `12845056`（即`16384*28*28`） |
...
-   **图片数量限制：**多图输入时根据传入方式不同，支持的图片数量上限有所区别：
    ...
    -   以公网URL或本地路径传入时：
        ...
        -   Qwen3.6-Plus、Qwen3.6-Flash、Qwen3.5-Plus、Qwen3.5-Flash、Qwen3-VL、Qwen-VL、QVQ系列：最多 256 张
