...
| Thinking Mode Toggle<sup>(1)</sup> | `{"thinking": {"type": "enabled/disabled"}}` |  |
| Thinking Effort Control<sup>(2)(3)</sup> | `{"reasoning_effort": "high/max"}` | `{"output_config": {"effort": "high/max"}}` |
