...
| Presentation-Installation | An in-memory commit Installation derived from an InstallationShare that has no normal commit twin. | [overview.md](architecture/overview.md#domain-model) |
