...
字段与可见性的权威定义见 [领域模型](../../doctidex-git/architecture/index.md)，
...
[子系统与生命周期](../../doctidex-git/architecture/product-and-user-surfaces.md)和
[约束与失败](../../doctidex-git/architecture/operation-safety-and-recovery.md)。本记录中的表只
