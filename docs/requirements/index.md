...
| 0022 | [优化 doctidex 安装、版本与缓存指引](0022-optimize-doctidex-installation-guidance.md) | 定义同 tag 的 Python package 安装与跨 host Published Skill bundle 获取、版本关系、双语 README 与 cache 环境变量配置。 | `draft` |
